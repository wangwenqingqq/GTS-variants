...
__global__ void searchD(int *data_info, float *data_d, int qid, Obj obj, int in_size, int *insert_list)
{
...
// range query
void searchNaiveRnn(int *data_info, Obj &obj_r, float *data_d, char *data_s, int *size_s, int qid, int in_size, float r,
