...
__global__ void findNextRnn(int *query_node_list, int start_idx, TN *node_list, float r, float *data_d,
...
__global__ void getQpDis(int start_idx, TN *node_list, float *data_d, int *qid_list, int *data_info, int *empty_list,
...
__global__ void leafProcessRnn(int *query_lnode, TN *node_list, int *id_list, int *query_qid, float *data_d,
...
__global__ void leafProcessKnn(int *query_lnode, TN *node_list, int *id_list, int *query_qid, float *data_d,
...
// Range query
void searchIndexRnn(float *data_d, TN *node_list, int *id_list, int *max_node_num, int *qid_list,
...
// knn query
void searchIndexKnn(float *data_d, TN *node_list, int *id_list, int *max_node_num, int *qid_list,
