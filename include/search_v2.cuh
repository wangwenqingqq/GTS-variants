...
__global__ void nodeProcessRnn(TN *node_list, float r, float *data_d, int *qid_list, int *data_info, int *empty_list,
...
// Process the nodes of the current layer and determine if the node will be pruned.
__global__ void dataProcessRnn(TN *node_list, float r, float *data_d, int *qid_list, int *data_info, char *data_s, int *size_s,
...
// Process the nodes of the current layer and determine if the node will be pruned.
__global__ void dataProcessKnn(TN *node_list, float *disk, float *data_d, int *qid_list, int *data_info, char *data_s, int *size_s,
...
__global__ void getDisPQ(TN *node_list, float *data_d, int *qid_list, int *data_info, int *empty_list, char *data_s,
...
// Range query
void searchIndexRnnV2(float *data_d, TN *node_list, int *id_list, int *max_node_num, int *qid_list,
...
// knn query
void searchIndexKnnV2(float *data_d, TN *node_list, int *id_list, int *max_node_num, int *qid_list,
