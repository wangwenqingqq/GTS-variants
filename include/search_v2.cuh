...
__constant__ float input_scale[3] = {0.25309202, 0.32743514, 0.21104065};

// Layer 1 Weights (8x3)
__constant__ float w1[8][3] = {
    {-2.565799, 1.436593, 0.156354},
    {-2.809419, 0.499494, -0.166494},
    {-0.323901, -0.092303, -0.107067},
    {-2.438639, 1.328902, -0.187325},
    {-3.040415, 1.430101, -0.262555},
    {-0.182769, -0.044496, 0.146773},
    {-3.413215, 1.914391, -0.244940},
    {-6.060064, 4.134491, 0.099019},
};

// Layer 1 Bias
__constant__ float b1[8] = {
    0.156384, 0.427434, -0.083614, 0.231951, 0.378070, -0.215416, 0.302754, 0.120477
};

// Layer 2 Weights (1x8)
__constant__ float w2[8] = {
    1.319283, 0.824526, -0.244719, 0.519823, 0.718273, 0.077997, 1.099575, 4.927382
};

// Layer 2 Bias
__constant__ float b2 = -0.524952;
					  ...
					  int qnum, int k, int tree_h, int *data_info, int *empty_list, char *data_s, int *size_s)
{
	...
	// if (fp == nullptr)
	// {
	// 	fprintf(stderr, "Failed to open training_data.csv for writing.\n");
	// }
	// else
	// {
