...
__global__ void getPivotDis(float *data_d, char *data_s, int *size_s, TN *node_list, int *split_list, double *dis_list,
...
__global__ void nodeSplit(TN *node_list, int *split_list, double *dis_list, int *empty_list, int start_idx,
						  int *pid_list, float *data_d, int *id_list, int *data_info, char *data_s, int *size_s)
{
	int bid = blockIdx.x;
	int tid = threadIdx.x;
	int nid = start_idx + bid;
...
void indexConstru(float *data_d, char *data_s, int *size_s, int *data_info, int *&id_list, TN *&node_list, int *&max_node_num,
