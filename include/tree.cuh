...
// 	// Get memory info after allocations
...
// 	printf("Memory used by indexConstru: %zu bytes\n", used_mem);
...
peak_mem_usage = max(peak_mem_usage, total_mem_usage);
printf("Memory used by indexConstru: %zu MB\n", used_mem/1024.0/1024.0);
...
printf("Peak memory used by indexConstru: %zu MB\n", peak_mem_usage/1024.0/1024.0);
printf("Total memory used by indexConstru: %zu MB\n", total_mem_usage/1024.0/1024.0);
}