...
int main(int argc,char** argv) try {
    ...
    std::string policy=argv[4],mode=argv[5];require(policy=="D"||policy=="B","invalid policy");require(mode=="check"||mode=="timing"||mode=="profile","invalid mode");
    ...
    for(int i=0;i<(mode=="timing"?8:3);++i) {
